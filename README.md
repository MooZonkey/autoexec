Please download from the releases menu to the right, which can be found here:
https://github.com/MooZonkey/autoexec/releases 

If you are experiencing network issues, please download and use one of the supplemental networking cfg files here:
...
The remainder of this 'read me' section will serve as a repository for my personal favorite configuration changes to TF2. 

HUD: https://github.com/quickkennedy/quakehud
